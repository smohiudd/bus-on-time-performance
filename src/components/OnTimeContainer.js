    ...
    return(
      <div className="inline-block mr6">
        <div className="select-container">
          <select onChange={props.handleRouteChange} value={props.routeValue} className="select select--border-yellow mb6 txt-s">
                {optionItems}
          </select>
...
function SelectDay(props){
    ...
    return(
      <div className="inline-block mr6">
        <div className="select-container">
          <select onChange={props.handleDayChange} value={props.dayValue} className="select select--border-yellow txt-s mb12">
                {optionItems}
          </select>
          <div className="select-arrow"></div>
        </div>
...
function OnTimeContainer(props) {
  return (
    <div className={onTimeStyles.container}>
      <div>
        <div className={onTimeStyles.title}>Calgary Transit <br/> Schedule Deviation</div>
        <div className={onTimeStyles.subtitle}>Comparison of schedule deviation in minutes for May 2018 and May 2019. www.saadiqm.com</div>
        <SelectRoute routeValue={props.route} handleRouteChange={props.onRouteChange}/>
        <SelectDirection data={props.data} directionValue={props.direction} handleDirectionChange={props.onDirectionChange}/> <br/>
